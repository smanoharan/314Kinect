...
namespace Engine.FeatureExtraction
{
    ...
    public class SkinGMM
    {
        ...
        private Mixture<NormalDistribution> positive;
        private Mixture<NormalDistribution> negative;
        ...
        private SkinGMM()
        {
            BuildPositiveSkinModel();
            BuildNegativeSkinModel();
        }

        public double Evaluate(double[] x)
        {
            double pPos = positive.ProbabilityDensityFunction(x);
            double pNeg = negative.ProbabilityDensityFunction(x);
